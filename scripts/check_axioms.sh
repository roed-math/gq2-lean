...
SORRY_ALLOWLIST='GQ2/Statement.lean GQ2/GammaA.lean GQ2/BoundaryFrame.lean GQ2/BoundaryMapsWitness.lean GQ2/UnramifiedModel.lean GQ2/FoxHeisenberg.lean GQ2/SectionSix.lean GQ2/SectionSeven.lean GQ2/SectionEight.lean'  # Transgression.lean removed 2026-07-04: P-15i CLOSED (κ⁰_q hypothesis restored per docs/p15i-transgression-gap.md; splitting_of_global_cocycle + lemma_6_21 proved std-3, file sorry-free). HilbertLedger.lean removed 2026-07-04: P-15e O-finish CLOSED (all 6 sub-lemmas proved; whole file sorry-free; evensNorm_deepUnit_vanish = std-3 + B9/B11). Reconstruction.lean removed: exists_contSurj_of_card_le proved (P-02). RepIndependence.lean removed 2026-07-04: P-15d CLOSED (lemma_6_14 proved std-3, no B-axioms, sorry-free — inner-conjugation coboundary on V⋊C; statement moved out of SectionSix.lean, comment-pointer there). SectionThree.lean removed 2026-07-03: P-07 CLOSED (markedHom_bijective proved from B5, std-3; last §3 sorry). SectionThreeMarked.lean removed 2026-07-05: P-25 CLOSED all three §3-marked sorries — prop_3_10_gammaA, prop_3_10_local_marked, prop_3_14 all spliced; file sorry-free. BoundaryFrame: P-11 thm_4_2 (removed by P-17); BoundaryMapsWitness: P-25 prop_3_14 (21-field bundle; kit fiberProductExists/proPKernel_image_ge/ker_nuT_le_proPKernel/compatA/surjA all std-3) + P-25b tame_reciprocity REDUCTION (proved via density+units_gen, all std-3) — the two remaining sorries are the atoms tame_recip_uniformizer (μ(2)=ofAdd -1) and tame_recip_unitNeg3 (μ(-3)=1), the irreducible tame↔reciprocity bridge pro2F(W)=ker ν₂, pending P-25c/d/e or a minimal axiom (docs/p25-tame-reciprocity-plan.md); FoxHeisenberg: P-12 §5 statements (removed by P-13); SectionSix+SectionSeven: P-14 §§6–7 statements (removed by P-15a–i); SectionEight: P-16 §8 statements — 8.2×2, 8.3, 8.6×2, prop_8_9 (removed by P-16 O-half); UnramifiedModel: P-15f3 arf(Q0loc)=1 reduction-sorry (allowlisted 2026-07-05 to un-break the shared guard — was tracked-un-allowlisted; P-15f3 to remove on close)
