...
SORRY_ALLOWLIST='GQ2/Statement.lean GQ2/GammaA.lean GQ2/BoundaryFrame.lean GQ2/SectionThreeMarked.lean GQ2/FoxHeisenberg.lean GQ2/SectionSix.lean GQ2/SectionSeven.lean GQ2/SectionEight.lean'  # Transgression.lean removed 2026-07-04: P-15i CLOSED (κ⁰_q hypothesis restored per docs/p15i-transgression-gap.md; splitting_of_global_cocycle + lemma_6_21 proved std-3, file sorry-free). HilbertLedger.lean removed 2026-07-04: P-15e O-finish CLOSED (all 6 sub-lemmas proved; whole file sorry-free; evensNorm_deepUnit_vanish = std-3 + B9/B11). Reconstruction.lean removed: exists_contSurj_of_card_le proved (P-02). RepIndependence.lean removed 2026-07-04: P-15d CLOSED (lemma_6_14 proved std-3, no B-axioms, sorry-free — inner-conjugation coboundary on V⋊C; statement moved out of SectionSix.lean, comment-pointer there). SectionThree.lean removed 2026-07-03: P-07 CLOSED (markedHom_bijective proved from B5, std-3; last §3 sorry). BoundaryFrame: P-11 thm_4_2 (removed by P-17); SectionThreeMarked: P-06 §3 statements — only the two ν-surjectivities were removed by P-08/P-09/P-10; prop_3_10_local_marked (:64) + prop_3_14 (:84) REMAIN (tracked under P-25), which is why the file stays allowlisted; FoxHeisenberg: P-12 §5 statements (removed by P-13); SectionSix+SectionSeven: P-14 §§6–7 statements (removed by P-15a–i); SectionEight: P-16 §8 statements — 8.2×2, 8.3, 8.6×2, prop_8_9 (removed by P-16 O-half)
