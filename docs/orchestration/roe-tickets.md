...
| R11 | chiR + IsLabuteOrientation + surjectivity (im = {±1}×(1+4ℤ₂) = ℤ₂ˣ) | opus | `GQ2/Roe/ChiR.lean` | R9 ✓, R10 ✓ | **dispatched 2026-07-24 night** (torsion value phrased on drY·drX⁻² to stay R8-free; v₂(rootX²−1)=3 trap flagged in prompt — image needs rootX itself, available as chiR drX) |
...
| R15 | marked matching assembly (prop_1_1 clone; unique b with S = X^b, k-shear, prop_3_8 reuse; R2's isometry seed + b,u numerics as cross-checks) | fable | `GQ2/Roe/MarkedPro2.lean` (fills) | R7–R13 + R15a (hypothesis-parametrized, not R14) | queued |
