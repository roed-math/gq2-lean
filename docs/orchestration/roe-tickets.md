...
| R31b | Γ_R word substrate: WordCohBridgeR (gammaGenR/evalR/ofZ1wR/z1EquivR/h1EquivR/NR_le_ker_classify_R) + CorrectionR (push_*RelR, corrMark_{aR,y1R,cR}, wildValueR_correction, corrected_wildValueR, d1FunR_base_change) — spec in survey-gaussz §bridge + survey-stage-ii5 §5.2 | opus | `GQ2/WordCohBridgeR.lean` (or Roe/ twin), `GQ2/Roe/CorrectionR.lean` | R31 surveys ✓ | **dispatched 2026-07-25** — unblocks ALL of R31c–g |
...
| R31d | ii.3 multiplicity: descend_piBC_R, liftsOver_nonempty_gammaR, liftsOver_card_gammaR (+M_B pack copy) | opus | `GQ2/MStageCountGammaR.lean` | R31b | queued |
| R31e | ii.5 stageR136 chain: wTrace_R+sep_word_R, CoverLiftR kernel (SHARED with R31f — factor out), hZcount_gammaR, hsep_invariantChar_killsRelatorSumR, hsep_hom_gammaR, stageR136_gammaR_of_hcard | opus | `GQ2/RStage/GammaR.lean` (extend), `GQ2/Roe/CoverLiftR.lean` | R31b | queued |
