...
| R31c | ii.4 + shared obs layer: WordCoh2R obs block (obsR/obs_B2_eq_zero_R/obsH2_R+injective, relZPairR+comap), MixedBObsR (obs_inflation_R, mixedB_eq_relZPair_R), IotaGammaR, LedgerGammaR (exists_phiF_R retype, obs_varCoc_eq_mixedB_R, varCoc_class_ne_zero_R), HalfTorsorGammaR (exists_nonzero_varCoc_gammaR, **card_H2_gammaR_eq_two = SourceData.cardH2**, half_torsor_gammaR, lemma_8_6_gammaR) | opus | `GQ2/WordCoh2R.lean`, `GQ2/MixedBObsR.lean`, `GQ2/IotaGammaR.lean`, `GQ2/LedgerGammaR.lean`, `GQ2/HalfTorsorGammaR.lean` | R31b ✓ | **dispatched 2026-07-25** |
| R31d | ii.3 multiplicity: descend_piBC_R, liftsOver_nonempty_gammaR, liftsOver_card_gammaR (+M_B pack copy) | opus | `GQ2/MStageCountGammaR.lean` | R31b ✓ | **dispatched 2026-07-25** |
| R31e | ii.5 stageR136 chain: wTrace_R+sep_word_R, CoverLiftR kernel (SHARED with R31f — factor out), hZcount_gammaR, hsep_invariantChar_killsRelatorSumR, hsep_hom_gammaR, stageR136_gammaR_of_hcard | opus | `GQ2/RStage/GammaR.lean` (extend), `GQ2/Roe/CoverLiftR.lean` | R31b ✓ | **dispatched 2026-07-25** |
| R31f | ii.6 Phase140 residues: tcocycle_card/hZcard/hsep/hpartial _gammaR (+b1_of_pair_cochain_B2_R, mlift_of_relatorFree_marking_R T-stage, cupChi_iotaB_eq_zero_R) | opus | `GQ2/Phase140/GammaR/*.lean` | R31b, R31c, R31e (CoverLiftR) | queued |
| R31g | ii.7 GaussZ layer: KappaR (κ⁰ wildValueR evaluations split/ramified — hardest), x1Section bijections, RelatorGammaR, CoordGammaR, GammaRD twins + HeadSlots + SourceData wiring | fable | `GQ2/GaussZ/{KappaR,RelatorGammaR,CoordGammaR,GammaRD}.lean` | R31b, R31c; CoordGammaR's finite_vcocycle needs R31f's hZcard | queued |
