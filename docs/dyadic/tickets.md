...
| CB-S | **the gating spike**: state and prove (or refute) the degree-generic analogue of `IsSelfDual`'s count clause — WW3b's "NOT degree-generic" warning is the lane's largest sizing risk — and demonstrate the one-theorem factoring in miniature | opus | `GQ2/Dyadic/Count/Spike.lean` | CB1 ✓ | **dispatched 2026-08-01** (ww worktree, `dyadic-cbs`) — **verdict GREEN/AMBER/RED gates CB-1..CB-6** |
| CB-P | the candidate-side pro-2 bridge (generalize `maxPro2Bridge`, NOT `exists_pro2R`; Labute-free is this ticket's defining property) | opus | `GQ2/Dyadic/Count/ProTwo.lean` | CB1 ✓ | **dispatched 2026-08-01** (mc worktree, `dyadic-cbp`) — on AS2's shortest path |
