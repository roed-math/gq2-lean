...
| CB-3 | `liftsOver_card` — the remaining independent clause (CB-2 sized it ≈600 generic lines); NOT downstream of CB-VAR | opus | `GQ2/Dyadic/Count/Lifts.lean` (new) | CB-2 ✓, CB-H2 ✓ | **dispatched 2026-08-01** → `~/claude/gq2-dyadic-ww`, branch `dyadic-cb3` |
