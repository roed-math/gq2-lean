...
| P-13f | B: §5.15 duality assembly (`prop_5_15`; trivial-module Gram + simple via 5.12/5.13 + dévissage) | ⭐⭐⭐ | O | P-13b, P-13c, P-13d, P-13e | — | ◐ (Opus 2026-07-04) part (i) trivial-module **card clauses done** (`GQ2/TrivialSelfDual.lean`, std-3): `d1=(x₁,x₁)`, `#H²w=#A=#(A^∨)^C`, `#Z¹w=(#A)³`. Remaining: table-(25) degree-one pairing (needs general-offset `mixedB.z` + bilinearity), then simple factors (P-13d+5.13) & dévissage (P-13e) |
