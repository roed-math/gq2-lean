...
| P-08 | B: Lemmas 3.6–3.8 proofs (cyclotomic conjugation of peripherals; wild-relation shape) | ⭐⭐ | O | P-06 | B2, B8 | ⚠ escalated (Opus, 2026-07-03): infra-blocked, see `docs/section3-extraction.md` §Escalations 4 |
