...
/-! ⚠ **De-duplicated (ticket CB-DD).**  The `gen_top` input below used to be a local
`gammaGen_topGen`; it is now `GQ2.Dyadic.topGen_gammaR` (`GQ2/Dyadic/GammaRHom.lean` §2), which
this file imports.  The statement and proof were verbatim identical. -/
