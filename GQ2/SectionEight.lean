...
here**) and the central-cover bookkeeping (Lemma 8.2/8.3).  The P-16 proof campaign is
complete; the §9 induction consumes the boxed system of Prop 8.9 plus Lemma 8.3.
...
Axioms: none in this statement-layer file; the downstream proofs consume the documented
B6/B7/B9 budget and are `sorryAx`-free.
-/
