...
*Status*: sorried — the P-17 master induction (P-17i assembles P-17b–h; axioms
B1/B3c/B6/B7/B7′/B8/B9 enter through the ingredients, per App. D). -/
...
theorem thm_4_2_stratum (B : BoundaryMaps) (F : BoundaryFrame H E) {Y : Type} [Group Y]
    [TopologicalSpace Y] [DiscreteTopology Y] [Finite Y] (T : MarkedTarget H E Y)
