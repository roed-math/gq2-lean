...
private theorem powExp_spec (hpos : 0 < orderOf t) (σ : ↥(Subgroup.zpowers t)) :
...
private theorem zpowHom_of_pow (hpos : 0 < orderOf t)
    (hdvd : P ∣ (X ^ orderOf t - 1 : Polynomial (ZMod 2)))
...
@[simp] private theorem frobEquiv_apply (hmon : P.Monic) (y : AdjoinRoot P) :
    frobEquiv P hmon y = y ^ 2 := rfl

private theorem frobEquiv_pow_apply (hmon : P.Monic) (m : ℕ) (y : AdjoinRoot P) :
