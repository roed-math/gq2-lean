...
/-!
# P-15f2c2c3(iii): the orientation-clause witness discharge
...
import the `TameUnitOrientation` definition without pulling in the P-25 witness machinery, and
...
/-- **The orientation clause at the witness's tame coordinate** (P-15f2c2c3(iii), the witness
...
instantiation the P-19/P-20 assembly uses to discharge the orientation hypothesis of the moved
