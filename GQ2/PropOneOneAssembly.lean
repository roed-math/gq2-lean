...
`e_ab` is the proved Lemma 3.5, including `markedHom_bijective`; thus `prop_1_1` is complete.
Its literature footprint is `std-3 + B3c + B8`.
-/
...
(`lemma_3_5_marked_abelianization`, ticket P-07, including `markedHom_bijective`),
