...
@[simp] private lemma evalPi_of0 : evalPi (FreeProfiniteGroup.of 0) = piSigma := rfl
@[simp] private lemma evalPi_of1 : evalPi (FreeProfiniteGroup.of 1) = piX0 := rfl
@[simp] private lemma evalPi_of2 : evalPi (FreeProfiniteGroup.of 2) = piX1 := rfl

private theorem evalPi_surjective : Function.Surjective evalPi :=
...
@[simp] private lemma piClassifier_sigma : piClassifier.hom.toMonoidHom univMarking.σ = piSigma :=
  FreeProfiniteGroup.homEquiv_symm_of _ _ _
@[simp] private lemma piClassifier_tau : piClassifier.hom.toMonoidHom univMarking.τ = 1 :=
  FreeProfiniteGroup.homEquiv_symm_of _ _ _
@[simp] private lemma piClassifier_x0 : piClassifier.hom.toMonoidHom univMarking.x₀ = piX0 :=
  FreeProfiniteGroup.homEquiv_symm_of _ _ _
@[simp] private lemma piClassifier_x1 : piClassifier.hom.toMonoidHom univMarking.x₁ = piX1 :=
  FreeProfiniteGroup.homEquiv_symm_of _ _ _
...
@[simp] private lemma PhiMax_mk_gammaSigma : PhiMax (maxProPMk 2 GammaA gammaSigma) = piSigma :=
  (quotientLift_quotientMk _ _ _ _).trans phiP_gammaSigma

@[simp] private lemma PhiMax_mk_gammaX0 : PhiMax (maxProPMk 2 GammaA gammaX0) = piX0 :=
  (quotientLift_quotientMk _ _ _ _).trans phiP_gammaX0

@[simp] private lemma PhiMax_mk_gammaX1 : PhiMax (maxProPMk 2 GammaA gammaX1) = piX1 :=
  (quotientLift_quotientMk _ _ _ _).trans phiP_gammaX1

@[simp] private lemma PhiMax_mk_gammaTau : PhiMax (maxProPMk 2 GammaA gammaTau) = 1 :=
...
@[simp] private lemma PsiMax_piSigma : PsiMax piSigma = maxProPMk 2 GammaA gammaSigma := by
...
@[simp] private lemma PsiMax_piX0 : PsiMax piX0 = maxProPMk 2 GammaA gammaX0 := by
  show PsiMax (maxProPMk 2 (profinitePresentation {piRelator})
...
@[simp] private lemma PsiMax_piX1 : PsiMax piX1 = maxProPMk 2 GammaA gammaX1 := by
  show PsiMax (maxProPMk 2 (profinitePresentation {piRelator})
